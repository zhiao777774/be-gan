...
def conditional_d_loss(fake_score, fake_labels):
    return torch.nn.BCELoss()(fake_score, fake_labels)


def conditional_g_loss(fake_score, real_labels):
    return torch.nn.BCELoss()(fake_score, real_labels)
